...
void drawText() { /
  ...
  fill(98,245,31);
  textSize(20);
  text("5cm",670,height-height*0.0833);
  text("10cm",730,height-height*0.0833);
  text("15cm",800,height-height*0.0833);  
  text("20cm",880,height-height*0.0833);  
  text("25cm",950,height-height*0.0833);
  text("30cm",1030,height-height*0.0833);
  text("35cm",1100,height-height*0.0833);
  text("40cm",1180,height-height*0.0833);
  textSize(20);
  text("Nesne: " + noObject, width-width*0.875, height-height*0.0277);
